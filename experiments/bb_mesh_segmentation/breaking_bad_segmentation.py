...
from breaking_bad_dataset import BreakingBadDataset 
...
dataset_path = os.path.join(base_path, "data/mesh_with_label")


# === Load datasets

# Load the test dataset
test_dataset = BreakingBadDataset(dataset_path, train=False, k_eig=k_eig, use_cache=True, op_cache_dir=op_cache_dir)
test_loader = DataLoader(test_dataset, batch_size=None)

# Load the train dataset
if train:
    train_dataset = BreakingBadDataset(dataset_path, train=True, k_eig=k_eig, use_cache=True, op_cache_dir=op_cache_dir)
